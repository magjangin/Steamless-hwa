                    ...
                    sorted.ForEach(p =>
                        {
                            Application.Current.Dispatcher.Invoke(() =>
                                {
                                    vml.LoggingService.OnAddLogMessage(this, new LogMessageEventArgs($"플러그인 로드 완료: {p.Name} - 제작자: {p.Author} (v.{p.Version})", LogMessageType.Success));
                                });
                        });
